...
pub use types::{
    point, vector, BoundaryType, ConsDb, ExtraData, Frame, Glass, HasSurface, Layer, MatProps,
    Material, MatsDb, Meta, Model, Orientation, Point2, Point3, Polygon, Shade, Space, SpaceType,
